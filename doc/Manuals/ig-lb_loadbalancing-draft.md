...
- [2. Overview](#2-overview)
  ...
  * [2.2 Communication with external security servers: The cluster from the point of view of a cluster security server client](#22-communication-with-external-security-servers-the-cluster-from-the-point-of-view-of-a-cluster-security-server-client)
...
- [4. Database replication setup](#4-database-replication-setup)
  ...
  * [4.2 Creating a separate PostgreSQL instance for serverconf database](#42-creating-a-separate-postgresql-instance-for-serverconf-database)
    + [4.2.1 RHEL](#421-rhel)
    + [4.2.2 Ubuntu](#422-ubuntu)
...
- [5. Configuring data replication with rsync over SSH](#5-configuring-data-replication-with-rsync-over-ssh)
  * [5.1 Set up SSH between slave and master](#51-set-up-ssh-between-slave-and-master)
  * [5.2 Set up periodic configuration sync](#52-set-up-periodic-configuration-sync)
    + [5.2.1 Using systemd (RHEL)](#521-using-systemd-rhel)
    + [5.2.2 Using upstart and cron (Ubuntu)](#522-using-upstart-and-cron-ubuntu)
